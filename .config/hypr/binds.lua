...
hl.bind("CTRL + XF86AudioRaiseVolume", hl.dsp.exec_cmd("~/.scripts/audio/manual_gain.sh up"), { locked = true, repeating = true })
hl.bind("CTRL + XF86AudioLowerVolume", hl.dsp.exec_cmd("~/.scripts/audio/manual_gain.sh down"), { locked = true, repeating = true })
...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.workspace.swap_monitors({ monitor1 = "eDP-1", monitor2 = "DP-1" }))
